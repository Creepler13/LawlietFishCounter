 ...
 */
 ...
 function countFish(message) {
   ...
   for (let index = 0; index < imgs.length; index++) {
     ...
     if (!emojis.specific[emoji])
       emojis.specific[emoji] = { count: 0, src: img.src };
 
     emojis.specific[emoji].count++;
     emojis.total++;
   }
 ...
 function onMessage(message) {
   ...
   for (const key in emojis.specific) {
     ...
     img.src = emojis.specific[key].src;
     img.alt = key;
     img.draggable = "false";
     img.width = 18;
     img.height = 18;
     ...
     strong.textContent = "= " + emojis.specific[key].count + "\n";
     span.append(strong);
     message.embedDescription.append(span);
   }
